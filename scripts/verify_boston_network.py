...
def main():
    ...
    require(dates[0]=="2026-09-09" and dates[-1]=="2026-10-31" and len(dates)==53,"daily bounds")
    require(set(dates)<={p.stem for p in DAILY.glob("????-??-??.json")},"active daily file missing")
    print("Boston verification passed: 8 services, 124 stations, connected, 53 active days through October 31")
