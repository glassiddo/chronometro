...
def main() -> None:
    ...
    require(len(dates) == 57 and dates[0] == "2026-09-05" and dates[-1] == "2026-10-31", "Berlin calendar must end October 31")
    require({path.stem for path in daily_dir.glob("????-??-??.json")} == set(dates), "Berlin daily files differ from calendar")
